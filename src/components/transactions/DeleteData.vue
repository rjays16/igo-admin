  ...
  <div>
    ...
    <a-modal 
      ...
      <div class="delete-container">
        <p><strong>Transaction ID: {{ transaction_id }}<br>
        Account Description: {{ acct_description }}</strong></p>
...
export default defineComponent({
  props: ["transaction_id", "acct_description"],
  components: {
    DeleteOutlined,
  },
  setup() {
  ...
  methods: {
    ...
    submit() {
      ...
      axios.delete(`/transaction/delete/${this.transaction_id}`, {
